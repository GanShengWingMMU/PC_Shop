...
<style>
    ...
    .builder-dashboard { max-width: 1400px; margin: 40px auto 80px; padding: 0 20px; display: grid; grid-template-columns: 1fr 360px; gap: 40px; align-items: start; font-family: 'Inter', sans-serif; }
    ...
    .bot-badge { padding: 6px 12px; border-radius: 6px; font-size: 0.75rem; font-weight: bold; text-transform: uppercase; }
...
<div class="builder-dashboard">
    ...
    <div class="builder-main-column">
        ...
        <?php if (isset($_SESSION['error_msg'])): ?>
            <div style="background: rgba(239, 68, 68, 0.1); border: 1px solid #ef4444; color: #ef4444; padding: 15px; border-radius: 8px; margin-bottom: 20px; font-weight: bold; line-height: 1.5;">
            ...
            <div class="persona-grid">
                <div class="persona-col">
                    ...
                    <div class="metric-row">
                        <div class="metric-label"><span>Cyberpunk 2077</span> <span><?php echo $fps_cyberpunk; ?> FPS</span></div>
                    ...
                    <div class="metric-row">
                        <div class="metric-label"><span>CS:GO 2</span> <span><?php echo $fps_csgo; ?> FPS</span></div>
                ...
                <div class="persona-col">
                    ...
                    <div class="metric-row">
                        <div class="metric-label"><span>Premiere Pro</span> <span><?php echo $score_pr; ?> pts</span></div>
                    ...
                    <div class="metric-row">
                        <div class="metric-label"><span>Blender 3D</span> <span><?php echo $score_blender; ?> pts</span></div>
                ...
                <div class="persona-col">
                    ...
                    <div class="metric-row">
                        <div class="metric-label"><span>Code Compilation</span> <span><?php echo $score_code; ?> idx</span></div>
                    ...
                    <div class="metric-row">
                        <div class="metric-label"><span>Multitasking</span> <span><?php echo $score_multi; ?> idx</span></div>
                ...
                <div class="persona-col">
                    ...
                    <div class="metric-row">
                        <div class="metric-label"><span>4K Stream Stability</span> <span><?php echo $score_obs_4k; ?>%</span></div>
                    ...
                    <div class="metric-row">
                        <div class="metric-label"><span>V-Tube / Face Tracking</span> <span><?php echo $score_vtube; ?> idx</span></div>
    ...
    <div class="builder-sidebar-column">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <div>
                ...
                <div style="font-size: 1.5rem; color: #facc15; font-weight: 900;"><i class="fas fa-bolt" style="text-shadow: 0 0 10px rgba(251,191,36,0.4);"></i> <?php echo $total_wattage; ?> W</div>
            </div>
            ...
            <div style="margin-top: 5px; padding-top: 20px; border-top: 1px dashed rgba(255,255,255,0.1);">
                ...
                <div style="font-size: 2.2rem; color: var(--accent); font-weight: 900; text-shadow: 0 0 20px rgba(0,242,254,0.3);">RM <?php echo number_format($total_price, 2); ?></div>
            </div>

            <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 10px;">
                <?php if ($progress == 100): ?>
                    <a href="name_build.php" class="btn-action btn-select" style="text-align: center; font-size: 1.1rem; padding: 15px; box-shadow: 0 0 20px rgba(0,242,254,0.3);" title="Discounts applied at checkout!">
                        CHECKOUT <i class="fas fa-shopping-cart" style="margin-left: 8px;"></i>
                    </a>
                <?php else: ?>
                    <span class="btn-action" style="background: rgba(255,255,255,0.05); color: #64748b; cursor: not-allowed; padding: 15px; border: 1px dashed rgba(255,255,255,0.1); text-align: center;">
                        Complete Build to Checkout
                    </span>
                <?php endif; ?>
                
                <a href="save_build.php" class="btn-action" style="border: 1px solid var(--accent); color: var(--accent); background: transparent; text-align: center; padding: 12px;">
