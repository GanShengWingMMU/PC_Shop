...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2026 at 05:11 PM
...
(6, 'admin', '$2y$10$vA7ZObWf9ANoiU4MucDg7.1k9.ZxCy4zb0HUTik5gLaA3fbnO7F8S', 'admingridcitypc@gmail.com', 'Admin', NULL, NULL, '2026-06-16 17:19:24', 'Active');
...
(237, 1, 'Alvis', 'SuperAdmin', 'System Login', '127.0.0.1', '2026-07-07 23:08:19'),
(238, 6, 'admin', 'Admin', 'System Login', '127.0.0.1', '2026-07-07 23:09:08');
...
(7, 'My Custom Order', 1, '2026-07-07 13:43:15', 21680.00, 0, 0.00, 'Sheng Wing Gan | 0162058560\\r\\na0805, 205 Short Rd\\r\\n05602 Berlin, Johor', '', 'Completed'),
...
--
ALTER TABLE `password_history`
  ADD CONSTRAINT `password_history_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON DELETE CASCADE;
